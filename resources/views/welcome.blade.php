  ...
  <div class="container col">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        ...
        <p class="lead text-secondary fw-bold ">Ecoubica: La app para ciudadanos comprometidos. Encuentra puntos clave, gestiona mejoras y colabora para un mundo más sostenible.</p>
      </div>
    </div>
  </div>
